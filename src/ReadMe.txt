...
JUnit dependencies were used to create tests, name the test, as well as the assertions import which allowed us to create the actual comparisons for our tests with expected compared to actual output based on the user input. 
